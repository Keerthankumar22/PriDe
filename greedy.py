...
def main():
    ...
    logging.basicConfig(filename="greedy_dynamic.log",filemode="w", level=logging.INFO)
    ...
    for vne_number in vnrs_for_dynamic : 
        ...
        vne_list[vne_number] = copy.deepcopy(new_vne[0])
        additional_vne.append(new_vne[0])    # TODO : improve
    # i = 0
    # for vnr_number in vnrs_for_dynamic : 
