...
def compute_katz(graph):
    ...
    #centrality = nx.katz_centrality(G, max_iter = 10000)  # uncomment to include katz
...
def topsis_ranking(graph_dict, graph, weight_mx, _perf_mx):  # not calling
...
def get_ranks(graph):
    ...
    attr_no = 5
    data = np.column_stack((degree,bw_centrality, eigen_centrality, strength, crb)) # To include katz un comment below line and line 132
