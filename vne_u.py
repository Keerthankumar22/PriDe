...
def create_vne(min_nodes=2, max_nodes=10, no_requests=1000, probability=0.4):
    ...
    for i in range(len(new_vne_req)):
        ...
        vne.append(graph_u.Graph(nodes, edges, Parameters(1, 5, 1, 10, 0, 100, 0, 100, 1, 1, 5, 12,5, 12, 10, 20, 0, 1)))
